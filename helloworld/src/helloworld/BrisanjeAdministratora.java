...
public class BrisanjeAdministratora {
	...
	private void initialize() {
		...
		frmBrisanjeAdministratora.setBounds(100, 100, 430, 450);
		...
		frmBrisanjeAdministratora.setJMenuBar(menuBar);
		...
		lblIzaberiteAdministratora.setBounds(22, 35, 126, 14);
		panel_1.add(lblIzaberiteAdministratora);
		
		JComboBox comboBox = new JComboBox();
		comboBox.setBounds(153, 32, 167, 20);
