...
public class PromjenaKlijenta {
	...
	private void initialize() {
		...
		frmModifikacijaKlijenta.setBounds(100, 100, 430, 450);
		...
		frmModifikacijaKlijenta.setJMenuBar(menuBar);
		...
		lblIzaberiteAdministratora.setBounds(22, 35, 88, 14);
		...
		button.setBounds(230, 323, 150, 23);
		panel.add(button);
