...
public class PromjenaPassworda {
	...
	private void initialize() {
		...
		frmPromjenaPassworda.setBounds(100, 100, 470, 320);
		...
		panel_2.setBounds(30, 30, 393, 150);
		panel.add(panel_2);
		...
		textField.setBounds(159, 34, 200, 20);
		panel_2.add(textField);
		
		JLabel lblPonoviteNoviPassword = new JLabel("Ponovite novi password:");
		lblPonoviteNoviPassword.setBounds(30, 115, 118, 14);
		panel_2.add(lblPonoviteNoviPassword);
		
		textField_2 = new JTextField();
		textField_2.setColumns(10);
		textField_2.setBounds(159, 59, 200, 20);
		panel_2.add(textField_2);
		
		textField_3 = new JTextField();
		textField_3.setColumns(10);
		textField_3.setBounds(159, 112, 200, 20);
		...
		textField_4.setBounds(159, 84, 200, 20);
		panel_2.add(textField_4);
		
		
		JButton btnPromjeniLinePodatke = new JButton("Promjeni password");
		btnPromjeniLinePodatke.setBounds(273, 191, 150, 23);
