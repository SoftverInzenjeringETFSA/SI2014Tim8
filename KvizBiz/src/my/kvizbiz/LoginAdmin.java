	...
	public LoginAdmin() {
		...
		btnPotvrdi.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {				
				JOptionPane.showMessageDialog(null,"Username koji ste unjeli je: " + textField.getText() + ", a password je: " + passwordField.getPassword() + " ... vec hashiran","Porukica",JOptionPane.WARNING_MESSAGE);
			}
		});
